...
menuBtn.addEventListener("click" , ()=> {
  ...
  // DropDown-menu
   ...
   menuDropdown.addEventListener("click" , () => {
    headerSubmenuItems.classList.toggle("active")
    headerInfo.classList.toggle("change")
  
    if(headerSubmenuItems.className === "header-submenu-items active") {
        menuDropdown.lastElementChild.style.transform= "rotate(-90deg)"
    }
    else{
        menuDropdown.lastElementChild.style.transform= "rotate(0deg)"
    }
